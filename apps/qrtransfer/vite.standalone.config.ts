 ...
 *   3. lib 构建抽出的 standalone CSS（nexos-app-qrtransfer.css）**内联**进
  ...
  return {
    ...
    closeBundle() {
      ...
      if (cssFiles.length) {
        ...
        const injector =
          `(function(){if(typeof document==="undefined")return;var d=document;var i=d.getElementById("nexos-app-qrtransfer-style");if(i)i.remove();var s=d.createElement("style");s.id="nexos-app-qrtransfer-style";s.textContent=${JSON.stringify(
            css,
