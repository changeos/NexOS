...
fn merge_tree_blocking(bare: &str, a: &str, b: &str) -> Result<String, String> {
...
fn merge_tree_with_base_blocking(
    bare: &str,
    onto: &str,
    commit: &str,
    merge_base: &str,
...
fn commit_meta_blocking(bare: &str, commit: &str) -> (Vec<(String, String)>, String) {
...
fn update_ref_blocking(bare: &str, base_ref: &str, commit: &str) -> Result<(), String> {
...
mod tests {
    ...
    fn merge_strategy_rebase_fast_forward_keeps_shas() {
        ...
        let sha =
            merge_with_strategy_blocking(&bare, "main", "feature", "", &MergeStrategy::Rebase)
                .expect("rebase 快进应成功");
    ...
    fn merge_strategy_rebase_conflict_returns_409_prefix() {
        ...
        // squash 同样冲突
        let err =
            merge_with_strategy_blocking(&bare, "main", "feature", "x", &MergeStrategy::Squash)
