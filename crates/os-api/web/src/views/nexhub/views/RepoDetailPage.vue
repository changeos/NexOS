...
import RepoReleasesTab from '@/views/nexhub/views/RepoReleasesTab.vue';
import RepoWebhooksTab from '@/views/nexhub/views/RepoWebhooksTab.vue';
...
const TAB_KEYS: RepoDetailTab[] = ['code', 'commits', 'manifest', 'ci', 'issues', 'pulls', 'releases', 'webhooks'];
...
function tabLabel(key: RepoDetailTab): string {
  switch (key) {
    ...
    case 'pulls':
      return 'PR';
    case 'releases':
      return t('nexhub.releases.tab');
    case 'webhooks':
      return t('nexhub.webhooks.tab');
  }
}
...
<template>
  <section class="detail-page">
    ...
    <div class="detail-body">
      ...
      <RepoReleasesTab v-show="tab === 'releases'" :repo-name="props.name" />
      <RepoWebhooksTab v-show="tab === 'webhooks'" :repo-name="props.name" />
    </div>
