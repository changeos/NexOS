...
>
> 项目采用契约驱动、分批合并的开发模型。2026-08-24 起转入 **semver tag 发版**（v0.1.0 → v0.1.51+，每功能批递增），此后的滚动变更记录见仓库根 `MEMORY.md`（工作记忆）与 NexHub 仓 tag——本文件保留下方的**开发阶段（批次/里程碑）史**。各阶段按时间**倒序**排列（最新在最上）。
>
